<header class="main-header">
            <a href="#" class="logo">
               <!-- Logo -->
               <span class="logo-mini" style="color: white;text-transform: uppercase;">
               {{ Auth::user()->name }}
               </span>
               <span class="logo-lg" style="color: white;text-transform: uppercase;">
               {{ Auth::user()->name }}
               </span>
            </a>
            <!-- Header Navbar -->
                              ...
                              <ul class="menu">
                                 <li >
                                    ...
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{asset('admin_assets/dist/img/basketball-jersey.png')}}" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>polo shirt</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{asset('admin_assets/dist/img/shirt.png" class="img-thumbnail')}}" alt="User Image">
                                       </div>
                                       <h4>Kits</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{asset('admin_assets/dist/img/football.png" class="img-thumbnail')}}" alt="User Image">
                                       </div>
                                       <h4>Football</h4>
                                 ...
                                 <li class="nav-list">
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{asset('admin_assets/dist/img/shoe.png" class="img-thumbnail')}}" alt="User Image">
                                       </div>
                                       <h4>Sports sheos</h4>
